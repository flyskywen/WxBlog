...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 自定义上下文管理器
                'blog.context_processors.settings_info'
            ],
        },
    },
]
...
CACHES = {
    "default": {
        ...
        # redis://:你的密码@服务器地址:6379/0
        # "LOCATION": "redis://:redisblog712!@127.0.0.1:6379/1",
        # 连接docker-compose创建的容器redis，将ip修改为redis的server name
        "LOCATION": "redis://:redisblog712!@redis:6379/1",
        "OPTIONS": {
